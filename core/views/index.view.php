			...
			<section id="accountOption">
				<div id="user-option" class="mt-4">
					<div class="flex w-full font-sans">		
						<a href="browse-missions.php" id="registerOption" class="hover:bg-bodycolor font-semibold p-4 w-1/6 text-xl font-sans mr-4 text-black bg-switchcolor text-center text-white">
							Browse Missions
						</a>
						<a href="./login.php" class="font-sans font-semibold w-1/6 text-xl p-4 text-black text-center w-1/6 bg-white hover:bg-gray-200">
							Login
						</a>
					</div>
				</div>
